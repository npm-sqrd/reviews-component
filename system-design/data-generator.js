...
fs.appendFileSync('restaurant-data.json', JSON.stringify(randomData(1000000)), (err) => {
  if (err) {
    console.log(err);
  } else {
...
// SEED_DATA:
// mongoimport --db restaurants_reviews --collection restaurants --file restaurant-data.json --jsonArray
